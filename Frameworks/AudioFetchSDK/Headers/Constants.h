...
//#define DLog(__FORMAT__, ...) memlog_printf(__FORMAT__, ##__VA_ARGS__)
#define DLog(format, ...) memlog_add( (char*) [ [NSString stringWithFormat:@"%s [LINE: %d] ==>> " format,__PRETTY_FUNCTION__, __LINE__, ## __VA_ARGS__ ] cStringUsingEncoding:[NSString defaultCStringEncoding] ] ,  true )
